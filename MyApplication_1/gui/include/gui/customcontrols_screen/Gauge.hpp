...
#elif defined(LCD8BPP_ABGR2222)
    PainterABGR2222 colorPainter;  ///< The painter for the needle
    PainterABGR2222 shadowPainter; ///< The painter for the needle shadow
#elif defined(LCD8BPP_RGBA2222)
    PainterRGBA2222 colorPainter;  ///< The painter for the needle
    PainterRGBA2222 shadowPainter; ///< The painter for the needle shadow
#elif defined(LCD8BPP_BGRA2222)
    PainterBGRA2222 colorPainter;  ///< The painter for the needle
    PainterBGRA2222 shadowPainter; ///< The painter for the needle shadow
#elif defined(LCD8BPP_ARGB2222) || USE_BPP==8
    PainterARGB2222 colorPainter;  ///< The painter for the needle
    PainterARGB2222 shadowPainter; ///< The painter for the needle shadow
#elif USE_BPP==4
